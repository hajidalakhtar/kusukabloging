  ...
  <ul>
    <li>
      <button
        ...
        @click="Bookmark()"
      >
        <i class="fas fa-2x mt-1 fa-bookmark"></i>
      </button>
      <button
        v-else
        style="  background-color: Transparent; background-repeat:no-repeat; border: none; cursor:pointer; overflow: hidden;  outline:none;"
        ...
        @click="Bookmark()"
      >
        <i class="far fa-2x mt-1 fa-bookmark"></i>
      </button>
    </li>
    <li>
      <button
        v-if="like"
        style="  background-color: Transparent; background-repeat:no-repeat; border: none; cursor:pointer; overflowhidden; outline:none;"
        href
        @click="Like()"
      >
        <i class="fas fa-2x mt-1 fa-heart"></i>
      </button>
      <button
        v-else
        style="  background-color: Transparent; background-repeat:no-repeat; border: none; cursor:pointer; overflow: hidden;   outline:none;"
        ...
        @click="Like()"
      >
        <i class="far fa-2x mt-1 fa-heart"></i>
      </button>
    </li>
  </ul>
</template>
