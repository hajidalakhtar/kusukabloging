            ...
            <div class="mainheading">
                ...
                <div class="row post-top-meta">
                    <div class="col-md-2 img-rp">
                        ...
                        <img src="{{asset('/storage/img/'.$user->poto)}}" alt="" class="author-thumb" width="1000px;"> @else
                        <img src="{{$user->poto }}" alt="" class="author-thumb"> @endif
                    </div>
                    <div class="col-md-10" style="margin-top: 3%">
                        <a class="link-dark" href="author.html">{{$user->name}}</a> @guest @if (Route::has('register')) @endif
                        @else @if (Auth::user()->provider_id === $user->provider_id)
                        <a href="{{Route('Create')}}" class="btn follow">Create Artikel</a>

                        <a href="{{Route('editprofile',$user->id)}}" class="btn follow">Edit Profile</a> @else @if ($followCount
                        == 1)
                        ...
                        <span class="post-date">{{count($blog1)}} Artikel</span><span class="dot"></span><span class="post-read">{{$like_count}} Like</span>
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <div class="container">
                            ...
                            <h4 class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content.
